...
# будет ругаться, что 1!=0
# хотя я вроде прошу при ошибках выдавать 1
test('./calc.exe "12/0"', 1, ['error']) 
# а тут я специально поставила 0=0, но он не справляется с чтением ['error']
test('./calc.exe "12/0"', 0, ['error'])
